export default {
  ...
  text: {
    ...
    contractSameDirectory:
      "Contract name must be unique under the same directory",
    ...
    fileExceeds:
      "File size exceeds 400k, please upload files smaller than 400k",
    txnDecodeBtn: "Decode",
    ...
    toggleOpen: "Open",
    toggleDown: "Down",
    privateKeyManagementInfo:
      "Support for exporting private keys, you can export private keys to local.",
    FileName: "privateKey Name",
    importFile: "Import File",
    pemName: "Pem File Name",
    appId:
      "Unique number of the application that registered the event notification",
    exchangeName: "Switch to which the queue belongs",
    queueName: "Queue name, usually appid",
    contractAbi:
      "ABI of contract, used for contract event analysis,list type;for example, [HelloWorld (string)]",
    contractAddress: "Contract address",
    fromBlock:
      "The minimum value is 0; the default value is latest, which means listening to the latest block",
    toBlock:
      "The minimum value is 0; the default value is latest, which means listening to the latest block",
    topicList:
      "There is no space between the list and event parameters of contract event, and multiple events are separated by English semicolons (;); for example, setevent (string, string); transferevent (address, uint256)",
    parse: "Parse",
    ...
    warehouseDes:
      "The contract warehouse provides common tool contracts and recommended application contract templates. The contract is for reference and testing only. Users can import contracts into their own directory.",
    ...
    cns: "CNS",
    registerCnsTips:
      "If the version number is empty, the current contract address has not been registered in CNS, you can enter the version number to register",
  ...
  contracts: {
    ...
    contractOpenTips:
      "Please click on the left panel to open a contract or create a new contract",
  ...
  nodes: {
    ...
    sealerText:
      "Set as sealer node, node will  sealer.Please contact professional settings",
    version: "Version",
