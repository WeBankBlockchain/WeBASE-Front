export default {
    ...
    contracts: {
        ...
        user: "User",
        params: "Params",
        paramsInfo: 'If the parameter contains double quotes, escape, for example: AAA\\"BBB. If the parameter type is an array, enter it in the following format, separated by commas. Non numeric and Boolean values must use double quotation marks, for example: ["AAA", "BBB"] and [100,101].',
        contractAddress: "Address",
        method: "Method",
