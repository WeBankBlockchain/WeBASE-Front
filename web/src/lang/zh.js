export default {
  ...
  text: {
    ...
    topicList:
      "合约Event事件的List，Event参数之间不带空格，且多个Event以英文分号(;)相隔；如 SetEvent(string,string);TransferEvent(address,uint256)",
    parse: "解析",
    remove: "移除",
    addParameter: "添加参数",
    functionType: "函数名",
    ...
    warehouseDes:
      "合约仓库中提供常用的工具合约和推荐应用合约模板。相关合约仅供参考和测试。用户可将合约导入到自己目录进行引入。",
    ...
    cns: "CNS",
    registerCnsTips:
      "如果版本号为空，则当前合约地址没有注册过CNS，可以输入版本号进行注册",
    registered: "已注册",
