  ...
  <div>
    ...
    <div class="module-wrapper" style="padding: 20px 20px 20px 20px;">
      <el-tabs v-model="activeName" @tab-click="handleClick">
            ...
            <div class="calc-hash">
              <el-tabs v-model="fileType" @tab-click="handleFileType">
                ...
                <el-tab-pane :label="$t('onlineTools.file')" name="file-second">
                  <div>
                    <div>
                      <el-upload ref="upload" class="upload-file-hash" :file-list="fileList" :show-file-list="true" :limit="1" drag action :http-request="uploadCrt" :before-upload="onBeforeUpload"
        ...
        <el-tab-pane :label="$t('route.eventCheck')" name="fourth" v-if="!liquidCheck">
...
import { queryLocalKeyStores, signHash, checkIsWasm } from "@/util/api";
