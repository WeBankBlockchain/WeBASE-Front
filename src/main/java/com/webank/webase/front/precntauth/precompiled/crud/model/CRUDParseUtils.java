...
public class CRUDParseUtils {
    ...
    public static void parseCreateTable(String sql, Table table)
        ...
        if (!keyFlag) {
            throw new FrontException("Please provide a primary key for the table.");
        }
        // parse value field
    ...
    public static Table parseAlterTable(String sql)
        ...
        for (AlterExpression alterExpression : alterExpressions) {
            if (alterExpression.getOperation() != AlterOperation.ADD) {
                throw new FrontException("Alter table only support ADD COLUMN now");
            }
    ...
    public static String parseTableNameFromSql(String sql)
        ...
        if (tableList.size() != 1) {
            throw new FrontException("Please provide only one table name.");
        }
    ...
    public static Entry parseInsert(String sql, Table table, Map<String, List<String>> tableDesc)
        ...
        if (insert.getSelect() != null) {
            throw new FrontException("The insert select clause is not supported.");
        }
        // parse table name
        ...
        if (columns != null) {
            if (columns.size() != itemArr.length) {
                throw new FrontException("Column count doesn't match value count.");
            }
    ...
    public static void parseSelect(
        ...
        if (selectBody.getOrderByElements() != null) {
            throw new FrontException("The order clause is not supported.");
        }
        if (selectBody.getGroupBy() != null) {
            throw new FrontException("The group clause is not supported.");
        }
        if (selectBody.getHaving() != null) {
            throw new FrontException("The having clause is not supported.");
        }
        if (selectBody.getJoins() != null) {
            throw new FrontException("The join clause is not supported.");
        }
        if (selectBody.getTop() != null) {
            throw new FrontException("The top clause is not supported.");
        }
        if (selectBody.getDistinct() != null) {
            throw new FrontException("The distinct clause is not supported.");
        }
        // parse select item
    ...
    private static void covertExpressionToCondition(
            Expression expr, String keyField, Condition condition) throws FrontException {
    ...
    private static void checkExpression(Expression expression) throws FrontException {
        if (expression instanceof OrExpression) {
            throw new FrontException("The OrExpression is not supported.");
        }
        if (expression instanceof NotExpression) {
            throw new FrontException("The NotExpression is not supported.");
        }
        if (expression instanceof InExpression) {
            throw new FrontException("The InExpression is not supported.");
        }
        if (expression instanceof LikeExpression) {
            logger.debug("The LikeExpression is not supported.");
            throw new FrontException("The LikeExpression is not supported.");
        }
        if (expression instanceof SubSelect) {
            throw new FrontException("The SubSelect is not supported.");
        }
        if (expression instanceof IsNullExpression) {
            throw new FrontException("The IsNullExpression is not supported.");
        }
    }
    ...
    public static void invalidSymbol(String sql) throws FrontException {
        if (sql.contains("；")) {
            throw new FrontException("SyntaxError: Unexpected Chinese semicolon.");
        } else if (sql.contains("“")
                || sql.contains("”")
                || sql.contains("‘")
                || sql.contains("’")) {
            throw new FrontException("SyntaxError: Unexpected Chinese quotes.");
        } else if (sql.contains("，")) {
            throw new FrontException("SyntaxError: Unexpected Chinese comma.");
        }
    }
}
