...
public class ErrorCodeHandleUtils {
	...
	public static final RetCode PRECOMPILED_PERMISSION_DENIED = RetCode.mark(-50000, "table name already exist");
	public static final RetCode PRECOMPILED_TABLE_NAME_EXIST = RetCode.mark(-50001, "table does not exist");
	public static final RetCode PRECOMPILED_TABLE_NOT_EXIST = RetCode.mark(-50100, "unknow function call");
	public static final RetCode PRECOMPILED_UNKNOWN_FUNCTION_CALL = RetCode.mark(-50101, "address invalid");
	public static final RetCode PRECOMPILED_ADDRESS_INVALID = RetCode.mark(-50102, "table name and address already exist");
	public static final RetCode PRECOMPILED_TABLE_NAME_AND_ADDRESS_EXIST = RetCode.mark(-51000, "table name and address does not exist");
	public static final RetCode PRECOMPILED_TABLE_NAME_AND_ADDRESS_NOT_EXIST = RetCode.mark(-51001, "invalid node ID");
	public static final RetCode PRECOMPILED_INVALID_NODE_ID = RetCode.mark(-51100, "the last sealer cannot be removed");
	public static final RetCode PRECOMPILED_LAST_SEALER_CANNOT_REMOVE = RetCode.mark(-51101, "the node is not reachable");
	public static final RetCode PRECOMPILED_NODE_NOT_REACHABLE = RetCode.mark(-51102, "the node is not a group peer");
	public static final RetCode PRECOMPILED_NODE_NOT_GROUP_PEER = RetCode.mark(-51103, "the node is already in the sealer list");
	public static final RetCode PRECOMPILED_NODE_ALREADY_SEALER = RetCode.mark(-51104, "the node is already in the observer list");
	public static final RetCode PRECOMPILED_NODE_ALREADY_OBSERVER = RetCode.mark(-51105, "contract name and version already exist");
	public static final RetCode PRECOMPILED_CONTRACT_NAME_VERSION_EXIST = RetCode.mark(-51200, "version string length exceeds the maximum limit");
	public static final RetCode PRECOMPILED_VERSION_LENGTH_EXCEED = RetCode.mark(-51201, "invalid configuration entry");
	public static final RetCode PRECOMPILED_INVALID_CONFIG_ENTRY = RetCode.mark(-51300, "contract name and version already exist");
