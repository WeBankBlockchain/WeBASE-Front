...
import com.webank.webase.front.exception.UnprocessableException;
...
public class KeyStoreService {
   ...
   public static Map<String, KeyStoreInfo> keyMap = new HashMap<>();
    /**
     * createPrivateKey.
     * 
     * @return
    ...
    public KeyStoreInfo createPrivateKey() {
       try{
            ...
            keyMap.put(address, keyStoreInfo);
          return keyStoreInfo;
        } catch (Exception e) {
           throw new UnprocessableException("create keyinfo failed");
        }
    }
