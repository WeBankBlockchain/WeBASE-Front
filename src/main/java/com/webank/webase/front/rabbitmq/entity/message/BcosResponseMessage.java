 ...
 */
@NoArgsConstructor
public class BcosResponseMessage extends BcosResponse implements MQObject {

    public BcosResponseMessage(BcosResponse response) {
    ...
    public String toString() {
        return "BcosResponseMessage:{" + "messageID:" + this.getMessageID() + ","
