...
package com.webank.webase.front.rpc;
...
public class PrecompiledWithSignServiceTest {
    ...
    @Autowired
    SysConfigServiceInWebase sysConfigServiceInWebase;
    ...
    public void testSysConf() throws Exception {
        String txLimit = sysConfigServiceInWebase.getSysConfigByKey(groupId, PrecompiledUtils.TxCountLimit);
//        System.out.println("==========1 " + txLimit);
        String value = "1024";
        String result = sysConfigServiceInWebase.setValueByKey(groupId, signAddress, PrecompiledUtils.TxCountLimit, value);
        String txLimit2 = sysConfigServiceInWebase.getSysConfigByKey(groupId, PrecompiledUtils.TxCountLimit);
