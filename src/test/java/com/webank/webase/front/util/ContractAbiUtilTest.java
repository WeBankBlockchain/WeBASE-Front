...
public class ContractAbiUtilTest extends TestBase {
    ...
    public void testDepolyContract() throws Exception {
        ...
        String encodedConstructor = ContractService
            .constructorEncodedByContractNameAndVersion(contractName, version, new ArrayList<>());

        CommonContract commonContract = null;
            commonContract = CommonContract.deploy(web3j, cryptoKeyPair, bytecodeBin, encodedConstructor);
        System.out.println(commonContract.getContractAddress());
        CnsService cnsService = new CnsService(web3j, cryptoKeyPair);
        RetCode result =  cnsService.registerCNS(contractName ,version,commonContract.getContractAddress(),"[{\"constant\":false,\"inputs\":[{\"name\":\"num\",\"type\":\"uint256\"}],\"name\":\"trans\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"get\",\"outputs\":[{\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"name\":\"num\",\"type\":\"uint256\"}],\"name\":\"TransEvent\",\"type\":\"event\"}]");
